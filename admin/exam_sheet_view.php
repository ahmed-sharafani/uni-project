...
<?php
//page of exam results of student. (and teacher ?)
...
/*if( mysqli_num_rows($istaken) == 0){
	echo "<script>alert('TThe Exam Is Not Taken By You')</script>";
...
$takdenData = mysqli_fetch_assoc($istaken);
...
if($rowcount == 0){
	...
	echo "<center>No Qeustion Is In This Exam<br>";
	echo "<a href='take_exam.php'>Back</a></center>";
	die('');
}
...
<div id="layoutSidenav_content">
	...
	<div class="container-fluid" style="margin-top:20px">
		<div class="col-md-12 alert alert-primary"> 
			...
			Exam Time: <span id="examtime" style="color:green"><?=$examData['exam_duration'];?></span> Seconds <hr>
			Your Time Duration: <span id="examtime" style="color:green"><?=$takdenData['duration'];?></span> Seconds <br>
		<!--	Score : <span id="examtime" style="color:green"><?=$takdenData['score'];?></span> <br>  old-->
			Score : <span id="examtime" style="color:green"><?=$takdenData['points'].'/ '.$examData['totalPoints'];?></span> <br>
			Points: <span id="examtime" style="color:green"><?=$takdenData['points'];?></span> <br>
		</div>
		<br>
		<div class="card">
			<div class="card-body">
