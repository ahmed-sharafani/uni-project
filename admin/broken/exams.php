...
if(isset($_POST['sendForm'])){  //for add new exam
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                               <button class="btn btn-success" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">  <i class="fas fa-table mr-1"></i>Add a New Exam </button>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered" width="100%" cellspacing="0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Total Points Of Exam</th>
                                              <!--  <th>Sum Of Points Of All Questions</th> -->
                                        ...
                                        <tbody>
                                             <?php
                                                 ...
                                                 while ($user = mysqli_fetch_assoc($run)) {
                                                  ...
                                                  /*
                                                  $examid=$user["ide"];
                                                  $query="SELECT SUM(Points) FROM questions WHERE examId=$examid";
                                                      $run2 = mysqli_query($con,$query) or die('MYSQL ERROR');
                                                      $tq=(int) mysqli_fetch_assoc($run2);
                                                      */
                                                      //added by  me tag
                                                    echo '
                                                    <tr>
                                                      ...
                                                      if($user['isPublic'] == 1){
                                                       ...
                                                       echo '<a href="qustions.php?id='.$user['ide'].'" class="btn btn-primary">EDIT QUESTIONS</a> ';
                                                       echo '<a href="exam_sheet_view_exam_answers.php?examcode='.$user['examCode'].'" class="btn btn-info">View Questions</a>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>  <!-- what is this ?-->
        </button>
      </div>
      <div class="modal-body">
        ...
        <div class="row">
          ...
          <div class="form-group">
            ...
            <input type="number" min="0" max="1000" required name="totalPoints" class="form-control" id="recipient-name">
          </div>
